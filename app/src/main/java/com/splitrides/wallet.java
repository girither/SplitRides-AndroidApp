...
public class wallet extends Fragment {
    ...
    SampleAdapter_noresults  walletadapter_comingsoon;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mGridView_comingsoon = (GridView)rootView.findViewById(R.id.coming_soon_list_wallet);
        ...
        walletadapter_comingsoon = new SampleAdapter_noresults(noresultsarray);
        mGridView_comingsoon.setAdapter(walletadapter_comingsoon);
        return rootView;
    }
