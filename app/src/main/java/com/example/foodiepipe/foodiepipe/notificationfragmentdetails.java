        ...
        protected notificationdata doInBackground(Void... param) {
            ...
            try {
                ...
                if(jObj != null){
                    ...
                    customer customeradapterdata = new customer(customerindividualdata.getString("name"),customerindividualdata.getString("email"),ride.getString("phoneNumber"),ride.getString("latlong"));
